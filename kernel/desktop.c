...
static void draw_about(Window*w){int bx=w->x+1,by=w->y+TITLE_H+1,bw=w->w-2,bh=w->h-TITLE_H-2;gfx_rect(bx,by,bw,bh,0xF0F4F8);gfx_display_text(bx+24,by+22,"ORION",0x1E4267);gfx_text(bx+28,by+93,"UN_Orion Desktop " VERSION,0x273A4D,1);gfx_text(bx+28,by+126,"Kernel architecture: " ORION_ARCH_NAME,0x63768A,1);gfx_text(bx+28,by+162,"Browser: UN_Vela 0.1.0",0x63768A,1);gfx_text(bx+28,by+195,"Engine: Aster 0.1.0",0x63768A,1);char s[64]="Free physical memory: ",n[24];u64dec(pmm_free_pages()/256,n);append(s,n,sizeof(s));append(s," MB",sizeof(s));gfx_text(bx+28,by+228,s,0x63768A,1);gfx_text(bx+28,by+261,"Traf Typeface v2.1",0x63768A,1);}
